...
{
    public partial class NtripForward8001 : ServiceBase
    {
        private ProxySetting settings = ConfigurationManager.GetSection("ntripProxySetting8001") as ProxySetting;
